 ...
 * \file
**/
#ifndef NT2_TOOLBOX_R_MATHLIB_FUNCTIONS_RLNORM_HPP_INCLUDED
#define NT2_TOOLBOX_R_MATHLIB_FUNCTIONS_RLNORM_HPP_INCLUDED
#include <nt2/include/simd.hpp>
#include <nt2/include/functor.hpp>

/*!
 * \ingroup r_mathlib
 * \defgroup r_mathlib_rlnorm rlnorm
 *
 * \par Description
 ...
 *   {
 *     template <class A0>
 *       meta::call<tag::rlnorm_(A0, A0)>::type
 *       rlnorm(A0 const& a0, A0 const& a1);
 *   }
 * }
 * \endcode
 *
...
namespace nt2 { namespace r_mathlib { namespace tag
  {         
    /*!
     * \brief Define the tag rlnorm_ of functor rlnorm 
     *        in namespace nt2::r_mathlib::tag for toolbox r_mathlib
    **/
    struct rlnorm_ {};
  }
  NT2_FUNCTION_IMPLEMENTATION(r_mathlib::tag::rlnorm_, rlnorm, 2)
  } }

#include <nt2/toolbox/r_mathlib/functions/scalar/rlnorm.hpp>
