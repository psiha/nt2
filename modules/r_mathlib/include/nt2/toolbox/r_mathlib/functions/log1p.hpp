 ...
 * \file
**/
#ifndef NT2_TOOLBOX_R_MATHLIB_FUNCTIONS_LOG1P_HPP_INCLUDED
#define NT2_TOOLBOX_R_MATHLIB_FUNCTIONS_LOG1P_HPP_INCLUDED
#include <nt2/include/simd.hpp>
#include <nt2/include/functor.hpp>

/*!
 * \ingroup r_mathlib
 * \defgroup r_mathlib_log1p log1p
 *
 * \par Description
 ...
 * 
 * \code
 * #include <nt2/toolbox/r_mathlib/include/functions/log1p.hpp>
 * \endcode
 * 
 * 
 * \synopsis
...
namespace nt2 { namespace r_mathlib { namespace tag
  ...
  NT2_FUNCTION_IMPLEMENTATION(r_mathlib::tag::log1p_, log1p, 1)
  } }

#include <nt2/toolbox/r_mathlib/functions/scalar/log1p.hpp>
